...
import { ArrowRight, MessageCircle, Sparkles, ShoppingBag, TrendingUp, Shield } from "lucide-react"
...
export default async function HomePage() {
  ...
  const jsonLd = {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `${process.env.NEXT_PUBLIC_SITE_URL || "https://thejasonstore.com"}/productos?q={search_term_string}`,
      },
        ...
        <main className="flex-1">
          ...
          <section className="container mx-auto px-4 py-20 md:py-32 relative">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild size="lg" variant="outline" className="text-base glass-card glass-hover bg-transparent">
                  <Link href="/contacto">
            ...
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <p className="text-sm text-muted-foreground">Gran variedad de categorías y marcas</p>
                </div>
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="h-12 w-12 rounded-full bg-accent/10 flex items-center justify-center">
                  ...
                  <p className="text-sm text-muted-foreground">Todos nuestros vendedores son confiables</p>
                </div>
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="h-12 w-12 rounded-full bg-accent/10 flex items-center justify-center">
                  ...
                  <p className="text-sm text-muted-foreground">Precios competitivos y promociones</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4 py-20">
            <div className="max-w-2xl mx-auto text-center glass-card p-12 rounded-lg relative overflow-hidden">
              ...
              <h2 className="text-3xl font-bold mb-4 relative z-10">¿Listo para Comprar?</h2>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed relative z-10">
                Contáctanos por WhatsApp y te ayudaremos a encontrar el producto perfecto. Respuesta inmediata
                garantizada.
              </p>
              <Button
                asChild
              ...
              >
                <a
                  href={`https://wa.me/5353118193?text=${encodeURIComponent("Hola, quiero información sobre los productos de The Jason Store")}`}
                  target="_blank"
